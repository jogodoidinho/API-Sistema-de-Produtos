package com.teste.maven.config;

import com.teste.maven.entities.*;
import com.teste.maven.entities.enums.OrderStatus;
import com.teste.maven.repositories.*;
...
public class testConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payments pay = new Payments(null,Instant.parse("2025-07-22T15:21:22Z"),o1);
        o1.setPayment(pay);
